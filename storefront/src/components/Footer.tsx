          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex space-x-4 mb-4">
              <a
                ...
                onClick={() => posthog.capture("social_link_clicked", { platform: "instagram", location: "footer" })}
              >
              ...
              <a
                ...
                className="text-white/70 hover:text-cs-orange transition-colors"
                aria-label="Facebook"
                onClick={() => posthog.capture("social_link_clicked", { platform: "facebook", location: "footer" })}
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
