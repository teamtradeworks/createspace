...
const skillColors = {
  beginner: "text-cs-green",
  intermediate: "text-cs-orange",
  advanced: "text-cs-purple",
};
...
export function QuickInfoBadges({
  ...
  if (skill) {
    allBadges.push({ icon: "skill", label: "Skill Level", value: skillLabels[skill] });
  }
  ...
  if (supervision !== undefined) {
    allBadges.push({
      ...
      value: supervision ? "Required" : "Not Required",
    });
  }
