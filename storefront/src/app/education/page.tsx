...
const schoolLogos = [
  { src: "/images/education/inspire-africa/school-logos/felixton-college.png", alt: "Felixton College" },
  { src: "/images/education/inspire-africa/school-logos/st-johns-college.png", alt: "St John's College" },
  { src: "/images/education/inspire-africa/school-logos/spark-school.png", alt: "Spark School" },
  { src: "/images/education/inspire-africa/school-logos/sweet-valley-primary.png", alt: "Sweet Valley Primary" },
  { src: "/images/education/inspire-africa/school-logos/thomas-more-college.png", alt: "Thomas More College" },
  { src: "/images/education/inspire-africa/school-logos/westcott-primary.png", alt: "Westcott Primary" },
  { src: "/images/education/inspire-africa/school-logos/wings-discovery-centre.png", alt: "Wings Discovery Centre" },
  { src: "/images/education/inspire-africa/school-logos/greenfield-girls-primary.png", alt: "Greenfield Girls Primary" },
];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/75 max-w-2xl leading-relaxed">
              Every school and family is different. Tell us about yourself and
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-xs font-semibold text-cs-orange uppercase tracking-widest mb-1">For Schools</p>
              <h2 className="text-xl font-semibold text-navy mb-3 leading-snug">
                We run the programme — you open the doors
              </h2>
              <p className="text-gray-500 text-sm leading-relaxed flex-1">
                Expert facilitators visit your school with all equipment. Ideal for after-school robotics, coding clubs, and holiday camps.
              </p>
            ...
            >
              ...
              <p className="text-xs font-semibold text-cs-blue uppercase tracking-widest mb-1">For Schools</p>
              <h2 className="text-xl font-semibold text-navy mb-3 leading-snug">
                Embed STEM into your existing teaching
              </h2>
              <p className="text-gray-500 text-sm leading-relaxed flex-1">
                Train your teachers to deliver CAPS-aligned STEM lessons confidently. Ready-to-use lesson plans, resources, and ongoing support included.
              </p>
            ...
            >
              <div className="w-14 h-14 bg-cs-purple/10 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-cs-purple" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-xs font-semibold text-cs-purple uppercase tracking-widest mb-1">For Homeschoolers</p>
              <h2 className="text-xl font-semibold text-navy mb-3 leading-snug">
                Flexible, quality STEM learning at home
              </h2>
              <p className="text-gray-500 text-sm leading-relaxed flex-1">
                Classroom-grade STEM kits and online courses designed to work at home. No classroom required — just curiosity.
              </p>
      ...
      <section id="tutors" className="py-24 bg-white scroll-mt-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Our partner <strong className="text-navy">Robotixkids</strong> provides trained, passionate facilitators
                who arrive at your school fully equipped — all kits, tablets, and materials included.
                Your learners get hands-on STEM without any prep burden on your teachers.
              </p>
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-gray-700">
                    <svg className="w-5 h-5 text-cs-orange flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              { src: "/images/education/stem-tutors/children-in-stem-classroom.jpg", alt: "Children in a STEM classroom" },
              { src: "/images/education/stem-tutors/boys-testing-robot-car.jpg", alt: "Boys testing a robot car" },
              { src: "/images/education/stem-tutors/girl-holding-robot-classroom.jpg", alt: "Girl holding a robot in class" },
              { src: "/images/education/stem-tutors/wro-robotics-competition.jpg", alt: "Learners at a robotics competition" },
            ].map((img) => (
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                ...
                training and CAPS-aligned curriculum resources. Once trained, your educators can deliver engaging
                STEM lessons independently — building lasting capability in your school.
              </p>
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-gray-700">
                    <svg className="w-5 h-5 text-cs-blue flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                    </svg>
                    {item}
                  </li>
          ...
          <div className="mt-16 pt-10 border-t border-gray-200">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8">
              {schoolLogos.map((logo) => (
                <div key={logo.src} className="grayscale hover:grayscale-0 opacity-60 hover:opacity-100 transition-all">
                  <Image
                    src={logo.src}
                    alt={logo.alt}
                    width={100}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                You don&apos;t need a classroom to deliver exceptional STEM education. Our self-paced
                online courses on the <strong className="text-navy">Inspire Africa</strong> platform let your child learn
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-gray-700">
                    <svg className="w-5 h-5 text-cs-purple flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                    </svg>
                    {item}
                  </li>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              {
                number: "80%",
                label: "of jobs in the next decade will require some form of tech or science literacy.",
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gray-50 rounded-3xl p-12 border border-gray-100">
            <div className="w-16 h-16 bg-cs-orange/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
              <svg className="w-8 h-8 text-cs-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-gray-500 leading-relaxed mb-8 max-w-xl mx-auto">
              Our team can help you assess your school&apos;s needs and find the perfect fit.
