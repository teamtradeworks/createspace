          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                The future belongs to problem-solvers, inventors, and creative thinkers. Here&apos;s
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              {[
                ...
                {
                  number: "3x",
                  label: "Faster growth in STEM careers compared to non-STEM jobs worldwide.",
                  color: "border-cs-blue",
                },
                {
                  number: "2x",
                  label: "Higher earnings for STEM graduates compared to non-STEM careers.",
