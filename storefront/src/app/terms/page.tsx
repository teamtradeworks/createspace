  ...
  return (
    <section className="py-16 lg:py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 [&_h2]:text-navy [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mt-10 [&_h2]:mb-4 [&_p]:mb-4 [&_p]:leading-relaxed">
          <p>
            ...
            It is assumed that the terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and
            &ldquo;our&rdquo; refers to CREATESPACE throughout the entirety of
            this document. We offer all information, tools and services available
          ...
          <p>
            ...
            &ldquo;Terms and conditions of use&rdquo;, including those
          ...
          <p>
            ...
            to use any trademark without the prior written permission of the
            website owner.
          </p>
          ...
          <p>
            ...
            Stitch. Stitch has robust Security &amp; Fraud Prevention by way of
            Extended Validation SSL with 2048-bit encryption, 3D secure and no
            credit card details are stored on the website. Customer details will
            be stored by CREATESPACE separately from card details which are
            entered by the client on Stitch&apos;s secure site. CREATESPACE
            takes all reasonable steps to scrutinise all transactions to prevent
            attempted fraud and a transaction may be refused if we are not
          ...
          <p>
            ...
            card, and/or orders that use the same billing and/or delivery
          ...
          <p>
            ...
            product delivery charges, transit times and availability. We reserve
          ...
          <p>
            CREATESPACE, our directors, officers, employees, affiliates, agents,
            contractors, interns, suppliers, service providers shall not be
            responsible for and disclaims all liability for any loss, liability,
            damage (whether direct, indirect or consequential), personal injury
            or expense of any nature whatsoever which may be suffered by you or
            any third party (including your company), as a result of or which
            may be attributable, directly or indirectly, to your access and use
            of the website, any information contained on the website, your or
            ...
            arising from any delays, inaccuracies, errors in, or omission of
            any share price information or the transmission thereof, or for any
          ...
          <p>
            Use of this website shall in all respects be governed by the laws of
            the Republic of South Africa, regardless of the laws that might be
            ...
            jurisdiction over all controversies arising under this agreement and
            agree that venue is proper in those courts.
          </p>

          <h2>Changes of Terms of Service</h2>
          <p>
