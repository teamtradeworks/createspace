  ...
  return (
    <section className="py-16 lg:py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl lg:text-4xl font-semibold text-navy mb-12">Terms of Service</h1>

        <div className="space-y-10 text-gray-600 leading-relaxed">
          <div>
            <p className="mb-3">
              This website is operated and hosted by Tradeworks Online (Pty) Ltd, company
              registration number 2021/432299/07, VAT number 4450302973, trading as CREATESPACE. It
              is assumed that the terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo;
              refers to CREATESPACE throughout the entirety of this document. We offer all
            ...
            <p className="mb-3">
              ...
              &ldquo;Service&rdquo; and agree to be bound by the following &ldquo;Terms and
              conditions of use&rdquo;, including those additional terms and conditions and policies
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Trademarks</h2>
            <p>
              The trademarks, names, logos and service marks (collectively &ldquo;trademarks&rdquo;)
              displayed on this website are registered and unregistered trademarks of the website
              owner. Nothing contained on this website should be construed as granting any license
              or right to use any trademark without the prior written permission of the website
              owner.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">General Conditions</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Products or Services</h2>
            <p className="mb-3">
              ...
              accurately as possible the colours and images of our products that appear at the store
              and cannot guarantee that you will receive exactly what is displayed on your screen.
            </p>
            <p className="mb-3">
          ...
          <div>
            ...
            <p>
              Payment is accepted via credit card (Visa or Mastercard). Online credit card
              transactions will be acquired for CREATESPACE via Stitch. Stitch has robust Security
              &amp; Fraud Prevention by way of Extended Validation SSL with 2048-bit encryption, 3D
              secure and no credit card details are stored on the website. Customer details will be
              stored by CREATESPACE separately from card details which are entered by the client on
              Stitch&apos;s secure site. CREATESPACE takes all reasonable steps to scrutinise all
              transactions to prevent attempted fraud and a transaction may be refused if we are not
          ...
          <div>
            ...
            <p className="mb-3">
              ...
              account, the same credit card, and/or orders that use the same billing and/or delivery
          ...
          <div>
            ...
            <p className="mb-3">
              ...
              (collectively, &ldquo;comments&rdquo;), you agree that we may, at any time, without
          ...
          <div>
            ...
            <p className="mb-3">
              ...
              descriptions, pricing, promotions, offers, product delivery charges, transit times and
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Prohibited Uses</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">External Links</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Warranties</h2>
            <p>
              CREATESPACE makes no warranties, representations, statements or guarantees (whether
              express, implied in law or residual) regarding the website.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Disclaimer of Liability</h2>
            <p>
              CREATESPACE, our directors, officers, employees, affiliates, agents, contractors,
              interns, suppliers, service providers shall not be responsible for and disclaims all
              liability for any loss, liability, damage (whether direct, indirect or consequential),
              personal injury or expense of any nature whatsoever which may be suffered by you or
              any third party (including your company), as a result of or which may be attributable,
              directly or indirectly, to your access and use of the website, any information
              contained on the website, your or your company&apos;s personal information or material
              and information transmitted over our system. In particular, neither the website owner
              nor any third party or data or content provider shall be liable in any way to you or
              to any other person, firm or corporation whatsoever for any loss, liability, damage
              (whether direct or consequential), personal injury or expense of any nature whatsoever
              arising from any delays, inaccuracies, errors in, or omission of any share price
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Conflict of Terms</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Severability</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Consumer Rights</h2>
            <p className="mb-3">
              Nothing in these Terms of Service is intended to limit or override your statutory
              rights under the Consumer Protection Act (Act 68 of 2008) or the Electronic
              Communications and Transactions Act (Act 25 of 2002). Where any provision of these
              Terms conflicts with your rights under those Acts, the relevant legislation shall
              prevail.
            </p>
            <p>
              In particular, your rights in respect of defective goods (section 56 of the CPA), the
              implied warranty of quality (section 55 of the CPA), and the cooling-off period for
              online purchases (section 44 of the ECTA) are non-waivable and apply in full. For
              details on returns and refunds, please see our{" "}
              <Link href="/refund" className="text-navy underline hover:text-cs-blue">
                Refund Policy
              </Link>
              .
            </p>
          ...
          <div>
            ...
            <p className="mb-3">
              Use of this website shall in all respects be governed by the laws of the Republic of
              South Africa, including but not limited to the Consumer Protection Act (Act 68 of
              2008), the Electronic Communications and Transactions Act (Act 25 of 2002), and the
              Protection of Personal Information Act (Act 4 of 2013), regardless of the laws that
              might be applicable under principles of conflicts of law.
            </p>
            <p>
              The parties agree that the South African courts of law shall have exclusive
              jurisdiction over all controversies arising under this agreement and agree that venue
              is proper in those courts.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Changes of Terms of Service</h2>
            <p>
          ...
          <div>
            ...
            <p>
              For full details on delivery timeframes, costs, and procedures, please refer to our{" "}
              <Link href="/delivery-policy" className="text-navy underline hover:text-cs-blue">
                Delivery Policy
              </Link>
