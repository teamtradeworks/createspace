...
export default async function NatGeoRockMineralStarterKitPage() {
  ...
  return (
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <HeroSection
        product={product}
        tagline="Fifteen real specimens: fool's gold, volcanic glass, rose quartz, and more."
        highlights={[
      ...
      <FeatureGrid
        ...
        features={[
          ...
          },
          {
            ...
            description:
              "Pyrite, iron sulfide with a cubic crystal structure and a gleaming gold lustre, is the specimen every kid reaches for first. Why does it look like gold but isn't? That question alone sends them straight to the identification guide.",
          },
          {
            icon: "puzzle",
      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "They're real. All 15 specimens are genuine geological samples: authentic rocks and minerals, not painted plastic or synthetic reproductions. That's part of the National Geographic promise: the same credibility behind their documentaries and magazines goes into what ends up in the box.",
          },
          {
            question: "How are the specimens stored?",
            answer:
              "The kit includes a clear acrylic display and storage case with individual moulded compartments, one for each specimen. The lid seals securely to keep everything in place and is transparent so the full collection is always visible. It's both functional storage and a display worth keeping out.",
          },
          {
            question: "Can my child identify the specimens on their own?",
            answer:
              "Yes, that's exactly what the full-colour identification guide is for. It covers each specimen with key identification details and interesting facts. Most children aged 8 and up will be able to work through it independently. Matching a specimen to its guide entry is genuinely satisfying, and a lot of the learning happens in the process.",
          },
          {
            question: "Does it need batteries, an app, or a screen?",
            answer:
              "None of the above. No batteries, no software, no device required. Just the specimens, the magnifying glass, and the guide. It's entirely hands-on and screen-free.",
          },
          {
            question: "Is it safe for younger children?",
            answer:
              "The specimens are natural materials: non-toxic rock and mineral samples. Some are small, so adult supervision is recommended for children under 6. For children aged 8 and up, it's designed to be used independently.",
          },
          {
            question: "What if my child wants more specimens after this?",
            answer:
              "That's the intended outcome. Rock collecting is one of the most popular naturalist hobbies worldwide and this kit is designed as a starting point. National Geographic offers other mineral and geology kits, and field collecting (picking up interesting rocks on hikes, at beaches, or in parks) is free. The acrylic case can be supplemented with additional cases as the collection grows.",
          },
        ]}
      />
