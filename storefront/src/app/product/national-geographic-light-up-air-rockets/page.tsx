      ...
      <FeatureGrid
        ...
        features={[
          ...
          },
          {
            ...
            description:
              "Each rocket has a switchable LED light built in. Flip them on as the sun goes down and watch glowing rockets arc against the darkening sky. Night launches become a completely different experience, extending play well past daylight hours.",
          },
          {
            icon: "target",
      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "Under two minutes. Unfold the base legs, slot the launch tube in, place a rocket on top, and you're ready to go. No tools, no assembly, nothing to figure out. Children can set it up themselves.",
          },
          {
