    ...
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <FeatureGrid
        ...
        features={[
          ...
          },
          {
            ...
            description:
              "Smooth rounded edges on every brick, low-voltage battery operation, and all electronics safely enclosed — designed for ages 5–8",
          },
        ]}
        columns={3}
        background="white"
        ...
        faqs={[
          {
            ...
            answer:
              "Not at all. The Smart Robot is designed for complete beginners aged 5–8. No coding, no app, no prior knowledge needed — just follow the 3D instructions and start building. It's one of the most accessible robotics kits available.",
          },
          {
            question: "What age is this suitable for?",
            answer:
              "We recommend ages 5–8. Children aged 5–6 may need a bit of help with more complex builds, while children 7–8 can usually work independently. The clear 3D instructions and chunky bricks are specifically designed for small hands and developing readers.",
          },
          {
      ...
      <Specifications
        ...
        specs={[
          ...
          { label: "Recommended Age", value: "5–8 years" },
...
export async function generateMetadata() {
  ...
  return {
    ...
    description:
      "Build 72+ moving robots with no coding required. The Makerzoid Smart Robot uses a built-in Intelligent Motor so robots react on their own. Ages 5–8.",
    alternates: {
