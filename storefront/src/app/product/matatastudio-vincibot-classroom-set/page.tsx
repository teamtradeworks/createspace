    ...
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <HeroSection
        ...
        highlights={[
          ...
          "Scratch and Python on one robot, with no equipment change needed",
      ...
      <ProjectShowcase
        ...
        projects={[
          ...
          },
          {
            ...
            description:
              "Use the ToF distance sensor to measure objects accurately, combining maths and coding in one activity.",
        ...
        moreText="Plus 69 more activities covering functions, variables, line following, TinyML, IoT, and creative drawing, plus 3 extended PBL engineering projects"
        background="white"
      />
      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "VinciBot is built from ABS plastic and passes 20+ professional quality and safety tests in manufacture. The rechargeable 1500mAh battery lasts 4+ hours per charge. Washable markers are used for drawing activities, so no permanent marks. The high-precision motors are designed for extended service life compared to the previous generation.",
          },
          {
            question: "Does VinciBot require internet connectivity?",
            answer:
              "A web browser or the MatataCode app is needed for coding (Windows, Mac, iOS, Android are all supported). However, VinciBot's AI and TinyML features (gesture recognition, voice recognition, and handwriting recognition) run entirely on-device with no internet required. This makes it reliable in schools with inconsistent connectivity.",
          },
          {
      ...
      <WhatsIncluded
        ...
        imageAlt="VinciBot Classroom Set contents laid out showing 6 robots, activity cards, maps, markers, and storage bin"
        items={[
