...
export default async function BlockarooTugBoatPage() {
  ...
  return (
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <HeroSection
        product={product}
        tagline="Build a tug boat. Float it. Take it apart. Start something new."
        highlights={[
      ...
      <ImageTextBlock
        ...
        body="The Tug Boat set gives children a starting point — 10 soft magnetic foam blocks that snap together effortlessly and rotate 360 degrees with a satisfying click. Children build the tug boat, take it apart, and start something new. Each block connects on the first try without needing to find a correct orientation, so children play independently from the very first session — just blocks that click together like magic."
        layout="image-left"
        background="white"
      />
      ...
      <CallToAction
        title="Set Sail"
        subtitle="10 magnetic foam blocks. One tug boat. Infinite builds."
