    ...
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <HeroSection
        ...
        highlights={[
          ...
          "Grows with your child, with optional Scratch programming for advanced learners",
        ]}
        addons={addons}
      />
      ...
      <ImageTextBlock
        ...
        body="Research shows that screen-free programmable robots are more effective than screen-based tools for developing computational thinking in preschoolers. Children benefit from connecting programming to concrete, physical objects; pressing a button to make the robot move forward reinforces cause-and-effect in a way that touching a screen does not. Tale-Bot Pro is designed for children as young as 3, with colour-coded command buttons and LED indicators that make debugging intuitive and visual, no reading required."
        layout="image-left"
        background="gray"
      />
        ...
        features={[
          {
            ...
            description:
              "Record up to 30 seconds of storytelling per file to develop language skills and creative expression",
          },
          {
            icon: "language",
            title: "11 Languages Supported",
            description:
              "Speaks English, French, German, Spanish, Mandarin, and more, making it suitable for multilingual learning",
          },
          {
            icon: "pencil",
            title: "Draws & Creates",
            description:
              "Includes washable markers so children can code the robot to draw shapes, patterns, and artwork",
          },
          {
            icon: "puzzle",
            title: "LEGO Compatible",
            description:
              "Build and customise with LEGO/DUPLO blocks to extend creative play beyond coding",
          },
          {
            icon: "map",
      ...
      <ImageTextBlock
        ...
        body="Tale-Bot Pro is a coding robot and a storytelling companion. Your child can transform it with replaceable sides, attach wings and arms, and use the built-in microphone to record imaginative narratives. Pair the robot with double-sided interactive maps featuring themes like frog life cycles and growing plants, or use the blank maps for open-ended exploration. The drawing feature lets children code the robot to create artwork, weaving STEM learning into creative play."
        layout="image-right"
        background="gray"
      />
      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "No! Basic coding requires zero screens; children use physical command buttons on the robot itself. The Scratch programming feature is optional and requires a tablet or computer, designed for older or more advanced learners who are ready for that next step.",
          },
          {
            question: "Does it require batteries?",
            answer:
              "Tale-Bot Pro has a built-in 1500mAh rechargeable lithium battery that lasts up to 4 hours between charges. Charge via the included USB-C cable. No disposable batteries needed.",
          },
          {
          ...
          },
          {
            ...
            answer:
              "Yes. Tale-Bot Pro is made from eco-friendly, food-grade materials and is lead-free. It features a sturdy, fall-resistant design. Important: contains small parts and is not suitable for children under 3 years due to choking hazard.",
          },
          {
