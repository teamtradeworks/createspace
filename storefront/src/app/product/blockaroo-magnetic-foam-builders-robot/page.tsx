...
export default async function BlockarooRobotPage() {
  ...
  return (
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <HeroSection
        product={product}
        tagline="Soft blocks that click together and hold. Build your robot, then build anything."
        highlights={[
      ...
      <FeatureGrid
        ...
        features={[
          ...
          {
            icon: "smile",
            title: "Bath Time Is Building Time",
            description:
              "The soft foam floats in water and clings to the metal liner in most bathtubs. Bath time, bedroom floor, or the kitchen table: the Blockaroo goes everywhere. And because every block is dishwasher-safe and mold-free, cleanup takes no effort.",
          },
          {
            icon: "layers",
      ...
      <CallToAction
        ...
        subtitle="10 magnetic foam blocks with endless builds and nothing to charge or set up."
