  ...
  return (
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
        ...
        features={[
          {
            ...
            description:
              "This isn't a toy that beeps randomly. The 18.8 cm dual coil detects real metal objects up to 10 cm underground. Kids find actual coins, jewellery, relics, and buried curiosities. The thrill of a genuine find changes everything.",
          },
          {
            icon: "eye",
            title: "Instant Alert, Every Time",
            description:
              "When the coil passes over something metallic, a bright LED flashes and an audible beep fires. No second-guessing: kids know immediately when they've found something and can pinpoint exactly where to dig.",
          },
          {
            icon: "compass",
            title: "Go Anywhere",
      ...
      <ImageTextBlock
        ...
        body="Every outing with this detector is a fresh hunt: a coin that's been underground for decades, a piece of jewellery from who-knows-when, or just a satisfying collection of found relics. Kids who detect regularly start looking at outdoor spaces differently: every park becomes a site worth investigating, every beach a question waiting to be answered. It's the kind of curiosity that doesn't switch off when the detector goes back in the bag."
        layout="image-left"
        background="gray"
      />
      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "No, the detector requires one 9V alkaline battery, not included. It's a standard battery available at any supermarket or hardware store. Stock one up before gifting.",
          },
          {
          ...
          },
          {
            ...
            answer:
              "Very. Slide the armrest into the handle, extend the telescoping shaft to a comfortable height, insert the battery, and you're ready. The whole process takes under 10 minutes and no tools are needed. The included guide walks through everything clearly.",
          },
          {
          ...
          },
          {
            ...
            answer:
              "Yes, some public parks, heritage sites, and national monuments prohibit metal detecting. Always check local rules before heading out. Private land requires the landowner's permission. The included Learning Guide covers responsible detecting ethics, including respecting property and filling all holes after digging.",
          },
        ]}
      />
