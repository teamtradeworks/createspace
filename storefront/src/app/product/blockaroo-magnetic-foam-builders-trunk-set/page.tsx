...
export default async function BlockarooTrunkSetPage() {
  ...
  return (
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <HeroSection
        product={product}
        tagline="50 soft magnetic foam blocks that build anywhere, even in the bath."
        highlights={[
          "50 blocks in a variety of 3D shapes and colours",
          "Magnets always attract and never repel, connecting on the first try every time",
          "Storage trunk included, with all 50 pieces organised and ready to go",
      ...
      <ImageTextBlock
        ...
        body="Enough blocks for robots, castles, trucks, animals, whole scenes. Pull it apart and start again. The Trunk Set is large enough for two children to build at the same time, making it as much a social toy as a solo one. The soft foam floats in water too, so the fun carries straight into bath time. Everything fits back in the trunk when play is done."
        layout="image-left"
        background="gray"
      />
        ...
        features={[
          {
            ...
            description:
              "Most magnetic toys frustrate young children when pieces push each other away. Blockaroo's patented magnet design means every block connects to every other block, every time, without any flipping or fiddling. That reliability makes a real difference for 3 and 4-year-olds who are just finding their building confidence.",
          },
          {
            icon: "refresh-cw",
          ...
          },
          {
            ...
            description:
              "The soft foam floats in water and clings to the metal liner in most bathtubs. Every block is 100% dishwasher-safe and mold-free, so cleanup takes no effort at all. Pop them in the top rack and they come out ready for the next session.",
          },
          {
            icon: "building-blocks",
            title: "50 Pieces, Infinite Combinations",
            description:
              "The Trunk Set is the biggest single Blockaroo set for home use, with enough shapes and sizes for complex, multi-story structures and entire scenes. Every block is also fully compatible with all other Blockaroo sets, so the collection can grow over birthdays and holidays.",
          },
        ]}
      />
      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "Yes. The blocks are made from soft, non-toxic foam with no sharp edges, so they're safe even for children who still mouth toys. The internal magnets are fully encased in foam and not accessible. Blockaroo blocks are safety tested to exceed international toy standards.",
          },
          {
      ...
      <CallToAction
        ...
        subtitle="Nothing to charge or set up. Just blocks that always click."
