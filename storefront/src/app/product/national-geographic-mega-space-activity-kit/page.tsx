  ...
  return (
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <ImageTextBlock
        ...
        body="Kids paint each planet using stencils, glow-in-the-dark paints, and metallic silver and gold, then stick the finished solar system straight onto the window with the included suction cups. It's one of those activities that keeps them busy for a whole afternoon and leaves something genuinely cool on the window when it's done."
        layout="image-left"
        background="gray"
      />
      ...
      <FeatureGrid
        ...
        features={[
          ...
          },
          {
            ...
            description:
              "The included Learning Guide goes beyond the activities: it's packed with facts about the planets, constellations, and the universe that keep kids curious long after the painting is dry.",
          },
        ]}
      />
      ...
      <ImageTextBlock
        ...
        body="The glow-in-the-dark reveal is the moment that makes this kit unforgettable. Glow stars on the ceiling. A solar system that lights up the window. The paints charge under any lamp or window light during the day, then do their thing at night. It's not a one-off experiment: it's a bedroom feature that stays there for weeks."
        layout="image-right"
        background="gray"
      />
      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "No batteries, no app, no downloads. The glow-in-the-dark paints and stars charge passively under any light source (a lamp or daylight through a window) and then glow in the dark. Nothing extra to buy or set up.",
          },
          {
          ...
          },
          {
            ...
            answer:
              "A genuine feel for the solar system and the night sky: the planets, their colours, their order, real constellation patterns. The hands-on nature of painting and placing means kids spend real time with each part, not just reading. Beyond the space content, they'll finish with three things they actually made: a launched rocket, a glowing constellation display, and a solar system hanging in the window.",
          },
        ]}
      />
