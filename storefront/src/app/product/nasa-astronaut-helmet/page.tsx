    ...
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <FeatureGrid
        ...
        features={[
          {
            icon: "sparkles",
            title: "A Visor That Opens and Closes",
            description:
      ...
      <ImageTextBlock
        ...
        title="The Helmet That Asks Questions"
        body="Somewhere between putting it on and adjusting the visor, children start wondering how astronauts actually breathe, what happens during a spacewalk, whether people could really live on Mars. The full-colour Learning Guide is included for exactly that: it covers the science behind space suits, life in microgravity, and what it takes to become an astronaut."
        layout="image-left"
        background="white"
      />
      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "The immediate result is extended, imaginative play. Children tend to build elaborate missions with a helmet that feels like the real thing, and the questions usually follow: how do astronauts sleep in zero gravity? Could people live on Mars? The Learning Guide gives those questions somewhere to go. A lot of children end up reading more about space afterwards.",
          },
        ]}
      />
      ...
      <CallToAction
        ...
        subtitle="Suit up, add your mission patches, and see where the story goes."
