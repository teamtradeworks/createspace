      ...
      <FeatureGrid
        ...
        features={[
          ...
          },
          {
            ...
            description:
              "The included learning guide and solar system poster are packed with fascinating facts about each planet and the Sun, the kind of details that make kids look up and ask more questions.",
          },
        ]}
      />
      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "Not really, that's one of the things parents love about this kit. The instructions are clear enough for confident 8-year-olds to work through independently. A light presence for the assembly step is useful the first time, but most children aged 9 and up will want to figure it out themselves.",
          },
          {
            question: "Can the planets be rearranged after it&rsquo;s built?",
            answer:
