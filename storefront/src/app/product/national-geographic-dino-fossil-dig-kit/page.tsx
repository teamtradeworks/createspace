  ...
  return (
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <ImageTextBlock
        ...
        title="Feel What It's Like to Be a Palaeontologist"
      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "The dig brick produces a fine gypsum and clay dust as it's chipped away. Work on a table covered with newspaper or an old cloth and the mess stays contained. The dust brushes up easily and the kit doesn't involve any liquids, paints, or staining materials. It's one of the tidier excavation activities you'll find.",
          },
          {
          ...
          },
          {
            ...
            answer:
              "Yes. The coprolite (fossilised dinosaur dung) is a genuine prehistoric specimen over 50 million years old. It has been tested and is safe to handle. The T-Rex tooth is a high-quality replica cast taken directly from an actual T-Rex tooth fossil, so it's accurate in shape and texture. You're getting one real fossil and one scientifically accurate replica.",
          },
          {
          ...
          },
          {
            ...
            answer:
              "A real sense of what palaeontologists do: careful, methodical work that rewards patience. They'll learn how fossils form, what coprolite tells scientists about dinosaur diet, and why the T-Rex tooth matters. More than the facts, they'll finish with something tangible: three specimens they uncovered themselves, and a story to tell about how they found them.",
          },
        ]}
      />
