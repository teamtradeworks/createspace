      ...
      <ProductFAQ
        ...
        faqs={[
          ...
          },
          {
            ...
            answer:
              "One of the nicest things about Moon Sand sticks only to itself, not to hands, clothes, or surfaces. It brushes off easily and the included play tray contains the sand during use. Cleanup is pretty painless. One child tester put it well: 'I love the texture and it's not too messy.'",
          },
          {
          ...
          },
          {
            ...
            answer:
              "Play sessions typically run 20–60 minutes, though children often return to the sand repeatedly rather than in one long stretch. The open-ended nature means there's no fixed endpoint: new scenes, new missions, and new questions keep coming. The kit stays playable for months.",
          },
          {
