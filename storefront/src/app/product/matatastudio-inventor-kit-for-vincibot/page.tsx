...
export default async function VinciBotInventorKitPage() {
  ...
  return (
    <ProductTrackingProvider handle={PRODUCT_HANDLE}>
      ...
      <HeroSection
        product={product}
        tagline="5 real electronic sensors and 7 guided projects to add electronics to your VinciBot"
        highlights={[
      ...
      <ImageTextBlock
        ...
        imageAlt="MatataStudio Inventor Kit builds showing LED tree, displays, and components in action"
        title="The Moment Electronics Clicks"
        body="Your child writes a condition: if temperature is above 25°C, turn on the fan. They press run. The servo motor whirrs. The fan spins. What was abstract code is now a physical response to the real world. That's physical computing: the same principle behind every smart device, IoT sensor, and home automation system. The Inventor Kit makes this moment tangible, playful, and completely within reach of a child aged 8."
        layout="image-left"
        background="gray"
      />
      ...
      <FeatureGrid
        ...
        subtitle="Each module teaches a different type of physical computing: sensing the environment, controlling movement, or creating light displays."
        features={[
          {
          ...
          },
          {
            ...
            title: "Joystick",
            description:
              "A 2-axis analog controller with push-button. Control VinciBot, build game interfaces, and create directional inputs using the same mechanism found in every game controller.",
          },
          {
          ...
          },
          {
            ...
            description:
              "A physical knob that outputs 0–270° of input. Control speed, brightness, or direction with a dial. Satisfying and intuitive, and a great way to learn analog input.",
          },
          {
      ...
      <ProjectShowcase
        ...
        projects={[
          ...
          },
          {
            name: "Fun Activities",
            description:
              "A collection of shorter, exploratory activities using all five modules, ideal for experimenting and getting comfortable with each component.",
      ...
      <Specifications
        ...
        specs={[
          ...
          { label: "Internet Required", value: "Yes (coding platform is browser-based)" },
