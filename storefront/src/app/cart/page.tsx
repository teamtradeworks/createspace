                ...
                <div className="bg-gray-50 rounded-2xl p-6 sticky top-24">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <div className="flex items-center gap-2 text-sm">
                      <svg className="w-5 h-5 text-cs-green flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <span>
                        ...
                        <span className="text-gray-500"> &middot; Protected by Stitch Payments</span>
                      </span>
                    </div>
                    <div className="flex flex-wrap gap-1.5 mt-3 ml-7">
                      {["Mastercard", "Visa", "Apple Pay", "Capitec Pay", "Buy Now Pay Later"].map((method) => (
                        <span key={method} className="text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded">
                          {method}
                        </span>
                      ))}
                    </div>
