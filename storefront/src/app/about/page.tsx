    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/80 max-w-2xl">
              We believe every child has the potential to become a scientist, engineer, or creator.
              Our mission is to provide the tools and inspiration to make that happen.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="relative">
              ...
              <div className="pl-8">
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  To provide a curated range of hands-on educational products and programmes in
                  science, technology, engineering and mathematics. We believe that early, playful
                  exposure to STEM builds curiosity, confidence, and a genuine appreciation for how
                  the world works.
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We&apos;re a team of educators and engineers who believe STEM should be hands-on, fun,
              and available to every kid in South Africa.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-semibold text-navy mb-4">Browse the Range</h2>
          <p className="text-gray-600 mb-8 max-w-xl mx-auto">
            Explore our curated collection of STEM products or get in touch to learn more about our
