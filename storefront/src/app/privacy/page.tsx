  ...
  return (
    <section className="py-16 lg:py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl lg:text-4xl font-semibold text-navy mb-12">Privacy Policy</h1>

        <div className="space-y-10 text-gray-600 leading-relaxed">
          <div>
            <p>
              This Privacy Policy is issued in compliance with the Protection of Personal
              Information Act (Act 4 of 2013) (&ldquo;POPIA&rdquo;). It explains how CREATESPACE
              collects, uses, stores, and protects your personal information when you visit our
              website or purchase from us.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Responsible Party</h2>
            <p className="mb-3">
            ...
            <p>
              For any privacy-related queries, you may contact our Information Officer at{" "}
              <a
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">What Information We Collect</h2>
            <p className="mb-3">
            ...
            <p>
              <strong>Email marketing (if applicable):</strong> With your permission, we may send
              you emails about our store, new products and other updates.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Purpose of Processing</h2>
            <p>
              We collect and process your personal information for the following purposes: to fulfil
              and deliver your orders, to process payments, to communicate with you about your
              orders, to improve our website and services, and, with your consent, to send you
          ...
          <div>
            ...
            <p className="mb-3">
              <strong>How do you get my consent?</strong> When you provide us with personal
              information to complete a transaction, verify your credit card, place an order,
              arrange for a delivery or return a purchase, we imply that you consent to our
              collecting it and using it for that specific reason only. If we ask for your personal
              information for a secondary reason, like marketing, we will either ask you directly
              for your expressed consent, or provide you with an opportunity to say no.
            </p>
            <p>
              <strong>How do I withdraw my consent?</strong> If after you opt-in, you change your
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Your Rights Under POPIA</h2>
            <p className="mb-3">
              As a data subject, you have the following rights in terms of POPIA:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                The right to be informed that your personal information is being collected, and the
              ...
              <li>
                The right to lodge a complaint with the Information Regulator if you believe your
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Disclosure</h2>
            <p>
          ...
          <div>
            ...
            <p className="mb-3">
              ...
              that are located in a different jurisdiction than either you or us. So if you elect to
              proceed with a transaction that involves the services of a third-party service
              provider, then your information may become subject to the laws of the jurisdiction(s)
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Data Breaches</h2>
            <p>
              In the event of a data breach that compromises your personal information, we will
              notify you and the Information Regulator as soon as reasonably possible, in accordance
          ...
          <div>
            ...
            <p>
              Our website uses cookies to improve your browsing experience. By continuing to use our
              website, you consent to our use of cookies in accordance with the terms of this
              policy. You may disable cookies in your browser settings, though this may affect
              website functionality.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Age of Consent</h2>
            <p>
              By using this site, you represent that you are at least the age of majority in your
              province of residence, or that you are the age of majority in your province of
          ...
          <div>
            <h2 className="text-lg font-semibold text-navy mb-3">Changes to This Privacy Policy</h2>
            <p className="mb-3">
              ...
              that it has been updated, so that you are aware of what information we collect, how we
