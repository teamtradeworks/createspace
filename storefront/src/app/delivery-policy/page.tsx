        ...
        <div className="space-y-10 text-gray-600 leading-relaxed">
          ...
          <div>
            ...
            <p className="mb-3">
              ...
              delivered to, but typical delivery times are between 1 and 3
              working days.
            </p>
            <p className="mb-3">
          ...
          <div>
            ...
            <p>
              The Courier Guy will attempt delivery up to 3 times. After the
              third attempt, the package will be returned to us and we will
              contact you to make further arrangements. If the failed delivery is
              proven to be the fault of CREATESPACE, we will dispatch your order
          ...
          <div>
            ...
            <p className="mb-3">
              Once your package has been sent you will receive an email
              confirming postal details including tracking and delivery
              information.
            </p>
            <p>
